...
import ru.kpfu.itis.robotics.dji_tracking.presenter.AppRegistrationPresenter;
...
public class AppRegistrationActivity extends AppCompatActivity implements View.OnClickListener, AppRegistrationView {
    ...
    private Button btnOpenTrackingActivity;
    ...
    public void showProductConnectionSuccess(String productName, boolean isApplicationRegistered) {
        ...
        btnOpenTrackingActivity.setEnabled(true);
    }
    ...
    public void showProductConnectionError() {
        ...
        btnOpenTrackingActivity.setEnabled(false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_open_tracking_activity: {
                Log.d(TAG, "btn_open_track click.");
                Intent intent = new Intent(AppRegistrationActivity.this, TrackingActivity.class);
    ...
    private void initView() {
        ...
        btnOpenTrackingActivity = findViewById(R.id.btn_open_tracking_activity);

        btnOpenTrackingActivity.setOnClickListener(this);
