...
public class DJIVideoStreamDecoder implements NativeHelper.NativeDataListener {
     ...
     * @param surface The displaying surface for the video stream. What should be noted here is that
     *                the hardware decoder would not output any yuv data if a surface is configured
     *                into, which mean that if you want the yuv frames, you should set "null" surface
     *                when calling the "configure" method of MediaCodec.
     */
