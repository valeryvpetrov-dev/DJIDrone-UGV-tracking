...
import ru.kpfu.itis.robotics.dji_movement.presenter.AppRegistrationPresenter;
...
public class AppRegistrationActivity extends AppCompatActivity implements View.OnClickListener, AppRegistrationView {
    ...
    private Button btnOpenMovementActivity;
    ...
    public void showProductConnectionSuccess(String productName, boolean isApplicationRegistered) {
        ...
        btnOpenMovementActivity.setEnabled(true);
    }
    ...
    public void showProductConnectionError() {
        ...
        btnOpenMovementActivity.setEnabled(false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_open_movement_activity: {
                Log.d(TAG, "btn_open_mission_control click.");
                Intent intent = new Intent(AppRegistrationActivity.this, MovementActivity.class);
    ...
    private void initView() {
        ...
        btnOpenMovementActivity = findViewById(R.id.btn_open_movement_activity);

        btnOpenMovementActivity.setOnClickListener(this);
